...
export function SwordViewer({ rotating, draw, reflections, lightAngle, cameraHeight, resetVersion, dropVersion, onStatus }: Props) {
 ...
 const settings=useRef({rotating,draw,reflections,lightAngle,cameraHeight});settings.current={rotating,draw,reflections,lightAngle,cameraHeight};
 useEffect(()=>{
 ...
 useEffect(()=>{scene.current?.update({rotating,draw,reflections,lightAngle,cameraHeight})},[rotating,draw,reflections,lightAngle,cameraHeight]);
