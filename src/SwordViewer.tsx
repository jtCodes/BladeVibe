...
export function SwordViewer({ model='longsword', rotating, draw, reflections, lightAngle, cameraHeight,effect,effectSpeed,effectIntensity, resetVersion, dropVersion, onStatus }: Props) {
