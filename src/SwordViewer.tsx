...
export function SwordViewer({ model='longsword', rotating, draw, reflections, lightAngle, cameraHeight,showSheath=true,swordRotation=0,effect,effectSpeed,effectIntensity, resetVersion, dropVersion, onStatus }: Props) {
 ...
 const settings=useRef({rotating,draw,reflections,lightAngle,cameraHeight,showSheath,swordRotation,effect,effectSpeed,effectIntensity});settings.current={rotating,draw,reflections,lightAngle,cameraHeight,showSheath,swordRotation,effect,effectSpeed,effectIntensity};
 useEffect(()=>{
 ...
 useEffect(()=>{scene.current?.update({rotating,draw,reflections,lightAngle,cameraHeight,showSheath,swordRotation,effect,effectSpeed,effectIntensity})},[rotating,draw,reflections,lightAngle,cameraHeight,showSheath,swordRotation,effect,effectSpeed,effectIntensity]);
