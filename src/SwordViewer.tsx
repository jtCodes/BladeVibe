...
export function SwordViewer({ viewState, active=true, sceneRef, effectSeek, effectPaused=false, bankaiPetalMotion='drift', model='longsword', glowStrength=.42, glowSpread=.8, petalGlow=4, upscaling='native', dragTarget='sword', antiAliasing='smooth', showPerformance=false, floorColor, backgroundColor, lighting, rotating, draw, reflections, lightAngle, cameraHeight,showSheath=true,swordRotation=0,effect,effectSpeed,effectIntensity, resetVersion, dropVersion, onStatus }: Props) {
