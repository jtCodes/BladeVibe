...
export function SwordViewer({ viewState, active=true, sceneRef, effectSeek, effectPaused=false, model='longsword', glowStrength=.42, glowSpread=.8, petalGlow=4, upscaling='native', dragTarget='sword', antiAliasing='smooth', showPerformance=false, floorColor='#141413', backgroundColor='#141413', lighting, rotating, draw, reflections, lightAngle, cameraHeight,showSheath=true,swordRotation=0,effect,effectSpeed,effectIntensity, resetVersion, dropVersion, onStatus }: Props) {
 ...
 const settings=useRef({viewState,effectSeek,effectPaused,glowStrength,glowSpread,petalGlow,upscaling,dragTarget,antiAliasing,showPerformance,lighting,rotating,draw,reflections,lightAngle,floorColor,backgroundColor,cameraHeight,showSheath,swordRotation,effect,effectSpeed,effectIntensity});settings.current={viewState,effectSeek,effectPaused,glowStrength,glowSpread,petalGlow,upscaling,dragTarget,antiAliasing,showPerformance,lighting,rotating,draw,reflections,lightAngle,floorColor,backgroundColor,cameraHeight,showSheath,swordRotation,effect,effectSpeed,effectIntensity};
 useEffect(()=>{
