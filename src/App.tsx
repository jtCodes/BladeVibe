...
export default function App(){
 ...
 return <>
  ...
  {!home&&!sword&&!ocular&&<main className="missing-sword"><p className="eyebrow">BladeVibe</p><h1>Page not found.</h1><AppLink href="/" className="text-link">Return to the collection</AppLink></main>}
 </>;
}
