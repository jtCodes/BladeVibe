...
export default function App(){
 ...
 useEffect(()=>{document.title=home?'The collection — BladeX':sword?`${sword.name}${editing?' · Editor':form?` · ${form==='bankai'?'Bankai':'Shikai'}`:''} — BladeX`:'Study not found — BladeX';},[home,sword,path]);
 return <>
  ...
  {!home&&!sword&&<main className="missing-sword"><p className="eyebrow">BladeX</p><h1>Study not found.</h1><AppLink href="/" className="text-link">Return to the collection</AppLink></main>}
 </>;
}
