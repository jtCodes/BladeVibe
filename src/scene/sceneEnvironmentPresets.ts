...
export const SWORD_ENVIRONMENT:SceneEnvironmentPreset={exposure:.85,background:'#141413',floor:'#141413',fogDensity:.032,ambient:{sky:0xb9d8ed,ground:0x1b1312,intensity:.14},studio:{neutral:false,intensity:.9,rotation:.35},lights:studioLights};
export const SENBONZAKURA_ENVIRONMENT:SceneEnvironmentPreset={...SWORD_ENVIRONMENT,background:'#03050d',floor:'#090b14',fogDensity:.022,ambient:{sky:0xb0b0b0,ground:0x0c0c0c,intensity:.09},studio:{neutral:true,intensity:.5,rotation:.35},lights:studioLights.map((light,i)=>({...light,color:0xffffff,intensity:[4,4.5,1.6,2.5,1.2][i]}))};
