...
export const swordModels={
 ...
 senbonzakura:{create:createSenbonzakura,physics:{bladeGeometry:createKatanaBladeGeometry,scabbardGeometry:createSayaGeometry,curveRadius:KATANA_RADIUS,katana:true,pommelY:SENBONZAKURA_POMMEL_TIP_Y},sheathOnSword:false},
