...
export const effectNames:Record<EffectMode,string>={off:'Bare steel',glow:'Glow & sparks',flame:'Flame',ice:'Ice',electric:'Electric',bankai:'Bankai'};
export const effectColors:Record<EffectMode,string>={off:'#85969f',glow:'#8cd8ff',flame:'#ff884d',ice:'#9ddff5',electric:'#e8dec0',bankai:'#ffa4d6'};
